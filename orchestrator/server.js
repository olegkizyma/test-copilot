...
import atlasStage1 from '../prompts/atlas/stage1_initial_processing.js';
import tetyanaStage2 from '../prompts/tetyana/stage2_execution.js';
import atlasStage3 from '../prompts/atlas/stage3_clarification.js';
import tetyanaStage4 from '../prompts/tetyana/stage4_retry.js';
import grishaStage5 from '../prompts/grisha/stage5_diagnosis.js';
import atlasStage6 from '../prompts/atlas/stage6_task_adjustment.js';
import grishaStage7 from '../prompts/grisha/stage7_verification.js';
import atlasStage9 from '../prompts/atlas/stage7_retry_cycle.js';
...
async function executeAgentStage(agentName, stageName, systemPrompt, userPrompt, session, options = {}) {
    ...
    if (WORKFLOW_CONFIG.shortStatusUpdates) {
